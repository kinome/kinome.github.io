...
KINOMICS.workers = (function () {
    ...
    createWorkerObj = function (start_obj) {
        ...
        lib.clearWorkers = function (callback) {
            /*////////////////////////////////////////////////////////////////////////////////
        ...
        lib.onComplete = function (callback) {
            ...
            This function sets the function to be called once all processes are complete
                ...
                if more are started.
            ARGV: callback - (function) function to execute once all submitted jobs have ran.
                    takes no parameters.
            */////////////////////////////////////////////////////////////////////////////////
        ...
        lib.submitJob = function (job, callback) {
            ...
            ARGV: job - (object) This will be submitted to the worker file, the file must then
