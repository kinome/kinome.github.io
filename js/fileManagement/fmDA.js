...
KINOMICS.fileManager.DA = (function () {
    ...
    lib.newAnalysisObject = function (initialObj) {
        ...
        ana.downloadURL = function (dataObj) {
            ...
            if (dataObj.self) {
                var json, blob, url;
                ana.data.collapse(function () {});
                json = JSON.stringify(ana.data.JSON);
                ana.data.expand(function () {});
    ...
    lib.newDataObject = function () {
        ...
        data.loadData = function (dataObj) {
            ...
            if (data.hasOwnProperty('JSON') && data.JSON.hasOwnProperty('parents') && data.JSON.parents.length) {data.collapse(function(){})};
